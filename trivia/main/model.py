...
class AdapterModel(nn.Module):
    def __init__(self, input_size=11008, adapter_size=4096, output_size=11008):
        super(AdapterModel, self).__init__()
        
        self.adapter = nn.Sequential(
            nn.SiLU(),
            nn.Linear(input_size, adapter_size,bias=False),
            nn.SiLU(),
            nn.Linear(adapter_size, output_size,bias=False),
