...
def collect_fn(batch):
    ...
    output=tokenizer(text=q_a_list,return_tensors="pt",padding=True,truncation=True,max_length=512)
...
class collateLM():
    ...
    def __call__(self, batch):
        ...
        for q, a ,all_a in batch:
            ...
            # print(ids.shape,mask.shape,target.shape)
        ...
        # print( tokens.shape, masks.shape, targets.shape)
